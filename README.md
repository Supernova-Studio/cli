...
running command...
$ supernova (--version)
@supernovaio/cli/0.1.2 darwin-x64 node-v12.21.0
...
_See code: [dist/commands/sync-design-tokens.ts](https://github.com/Supernova-Studio/cli/blob/v0.1.2/dist/commands/sync-design-tokens.ts)_
<!-- commandsstop -->
